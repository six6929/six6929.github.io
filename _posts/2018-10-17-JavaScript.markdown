...
<br>
HTML과 CSS는 정적인 언어인 반면, <b>JavaScript는 HTML과 CSS로 만들어진 웹페이지를 동적으로 변경해주는 언어입니다. 자바스크립트는 원래는 잘 사용되지 않는 스트립트 언어였습니다. 하지만 구글에서 지도 서비스를 HTML/CSS와 JavaScript만을 이용해 플래쉬와 같은 효과를 구현하면서 자바스크립트 열풍이 불기 시작했다고합니다.</b>
<br>
