...
<br>
<p style="border:1px dotted blue; font-size:80%">이렇게 자바스크립트와 HTML의 상호작용은 사용자가 이벤트를 일으켰을 때, 이벤트 핸들에 의해서 이루어지는 것을 알 수 있습니다. 이벤트는 더욱 다양한 형태로 발생하게 되는데 개발자들은 이런 이벤트들을 가로채서 원하는 행위를 하게 됩니다. </p>
